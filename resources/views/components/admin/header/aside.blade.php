<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="index.html" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">OndevF</span>
      </a>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-header small text-uppercase">
        <span class="menu-header-text">Porfoli</span>
      </li>
      <li class="menu-item">
      ...
      <li class="menu-item">
        <a href="" class="menu-link ">
          ...
          <div data-i18n="Authentications">Experiences</div>
        </a>
      ...
      <li class="menu-item">
        <a href="" class="menu-link ">
          ...
          <div data-i18n="Misc">Compétences</div>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href=" 
       {{ route('admin.bio.index') }}
       " class="menu-link ">
          <i class="menu-icon tf-icons bx bxs-archive"></i>
          <div data-i18n="Misc">Bibiographie</div>
        </a>
      </li>
